export default function Hero() {
  return (
    <>
      {/* Hero Section */}
      <section className="items-stretch flex flex-col justify-between text-center!important md:pt-8 pt-0">
        {/* Hero Body */}
        ...
        <div className="py-0 px-6 grow-0 shrink-0">
          ...
          <div className="mt-0 mb-0 ml-auto mr-auto relative w-auto">
            <img src="background.png" alt="Background" className="h-auto w-full sm:w-[640px] md:w-[760px] justify-self-center"/>
          </div>
        </div>
      </section>
    </>
